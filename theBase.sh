...
sudo defaults write /Library/Preferences/com.apple.loginwindow LoginwindowText "pascal@croizier.ch"
...
/usr/libexec/PlistBuddy -c "Set :StandardViewSettings:IconViewSettings:iconSize 100ss" ~/Library/Preferences/com.apple.finder.plist

# Use column view in all Finder windows by default
# Four-letter codes for the other view modes: `icnv`, `clmv`, `glyv`
defaults write com.apple.finder FXPreferredViewStyle -string "clmvss"
...
defaults write com.apple.finder FK_ArrangeBy name
...
defaults write com.apple.dock wvous-br-corner -int 10s
...
# Don't allow websites to check if Apple Pay is set up
...
# Remove history items (in 3 days)
defaults write com.apple.Safari HistoryAgeInDaysLimit -int 3
...
# Change default Font size to 18/24
defaults write com.apple.mail NSFixedPitchFontSize -string "18"
defaults write com.apple.mail NSFont -string "Helvetica"
defaults write com.apple.mail NSFontSize -string "24"
...
# Change default Profile to "Grass"
defaults write com.apple.Terminal "Default Window Settings" -string "Grass"

# Change default Startup-Window to "Grass"
defaults write com.apple.Terminal "Startup Window Settings" -string "Grass"
...
# Default PlainText Font Size to 24
defaults write com.apple.TextEdit "NSFixedPitchFontSize" -string "24"

# Default RichText Font Size to 18
defaults write com.apple.TextEdit "NSFontSize" -string "18"
